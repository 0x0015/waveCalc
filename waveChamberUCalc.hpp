...
inline AGPU_CALLABLE_MEMBER static double calculateUAtPos(vec2<unsigned int> pos, stateMembers currentStateVals, double previousStateVal, double partitionSize, double c, double dt, double mu){
