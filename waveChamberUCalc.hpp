...
inline constexpr AGPU_CALLABLE_MEMBER double calculateUAtPos(stateMembers currentStateVals, double previousStateVal, double partitionSize, double c, double dt, double mu){
